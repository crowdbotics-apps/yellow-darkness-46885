"""
Django settings for yellow_darkness_46885 project.
...
ROOT_URLCONF = 'yellow_darkness_46885.urls'
...
WSGI_APPLICATION = 'yellow_darkness_46885.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_darkness_46885 API",
    "DESCRIPTION": "API documentation for yellow_darkness_46885 App",
    "VERSION": "v1",
}
